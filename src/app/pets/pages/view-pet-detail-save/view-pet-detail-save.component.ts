...
@Component({
  selector: "app-view-pet-detail-save",
  templateUrl: "./view-pet-detail-save.component.html",
  styleUrls: ["./view-pet-detail-save.component.scss"],
  standalone: true,
  imports: [...coreImports, ...ionImports, ...nzImports],
})
export class ViewPetDetailSaveComponent implements OnInit {
